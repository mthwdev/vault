...
$process = Get-Process | Where-Object { $_.MainWindowTitle -like "*Riot*" } | Select-Object -First 1
if ($process) {
    ...
    Write-Output "clicking center of window: X=$centerX Y=$centerY"
    [Win32]::SetCursorPos([int]$centerX, [int]$centerY) | Out-Null
